...
$$\rho_{i,t}(\theta) = \frac{\pi_\theta(y_{i,t}\mid x,y_{i,<t})}{\pi_{\theta_{\mathrm{old}}}(y_{i,t}\mid x,y_{i,<t})} = \exp\left(\log\pi_\theta-\log\pi_{\theta_{\mathrm{old}}}\right).$$
...
$$J_{\mathrm{PPO}}(\theta) = \mathbb{E}_{i,t} \left[\min\left(\rho_{i,t}A_i,\, \operatorname{clip}(\rho_{i,t},1-\epsilon,1+\epsilon)A_i\right)\right].$$
...
$$d_t = \log\pi_{\theta_{\mathrm{old}}}(y_t\mid x,y_{<t})-\log\pi_T(y_t\mid x,y_{<t}).$$
