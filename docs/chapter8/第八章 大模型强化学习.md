...
\left[
D\bigl(\pi_T(\cdot\mid s),\pi_\theta(\cdot\mid s)\bigr)
\right].
$$
...
\sum_k
\frac{n_k}{N}
\operatorname{mean}(\mathcal L_k)
=
\operatorname{mean}(\mathcal L_{\mathrm{global}}).
$$
